...
public class Main {
	...
	public static void main(String[] args) {
		...
		Amphibia amph1 = (Amphibia) car2;  // погуглить
		...
		for (int i = 0; i < cars.length; i++) {
			if (cars[i] instanceof Truck) {
				...
				//amph2.setPassability(10); // всем амфиби€м задаем проходимость 10
			}
		}
		System.out.println("¬ массиве имеетс€ "+count1+" грузовых-машин");
		
		Swim[] boat = {new Amphibia(), new Amphibia(), new Amphibia()};
		int count2 = 0;
		...
		System.out.println("¬ массиве имеетс€ "+count2+" плавающих-машин");
